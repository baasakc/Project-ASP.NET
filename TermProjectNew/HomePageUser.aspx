<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HomePageUser.aspx.cs" Inherits="HomePageUser" %>
					...
					<div class="container">
						<div class="row">
							<div class="col-sm-7 text-left menu-1">
								<ul>
									<li class="active"><a href="HomePageUser.aspx">User Homepage</a></li>
									<li class="has-dropdown">
										<a href="ProposalsUser.aspx">Proposals</a>
										<ul class="dropdown">
											<li><a href="AddProposalUser.aspx">Add Proposal</a></li>
											
										</ul>
									</li>
									<li><asp:LinkButton  ID="LinkButtonLogout" runat="server">Logout</asp:LinkButton></li>
				...
				<aside id="sidebar">
					<div class="col-md-3">
						<div class="side animate-box">
							...
							<asp:Image ID="ImageProfilePic" ImageUrl="Templete/images/user-2.jpg" runat="server" />
								<h3><asp:Label ID="LabelNameAboutMe" runat="server" Text="Label"></asp:Label></h3>
								<strong class="role">
    <asp:Label ID="Label2" runat="server" Text="User"></asp:Label></strong>
								<p>
        <asp:Label ID="LabelInfo" runat="server" Text=""></asp:Label></p>
                                <br />
                                <asp:LinkButton ID="LinkButton1" PostBackUrl="~/EditUserInformations.aspx" runat="server">Edit Profile</asp:LinkButton>
							</div>
						</div>
	<%--					<div class="side animate-box">
							<div class="col-md-12 col-md-offset-0 text-center fh5co-heading fh5co-heading-sidebar">
			...
			<div class="row row-pb-md">
				...
				<div class="col-md-4 col-md-push-1">
					...
					<ul class="fh5co-footer-links">
						<li><a href="HomePageUser.aspx">User Homepage</a></li>
						<li><a href="ProposalsUser.aspx">Proposals</a></li>
