                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-7 text-left menu-1">
                                        <ul>
                                            <li class="active">
                                                <asp:LinkButton ID="LinkButtonHome" runat="server">Homepage</asp:LinkButton></li>
                    ...
                    <div class="row">
                        <div class="col-md-9 col-padded-right">
                            <div runat="server" class="row">
                                <asp:Label ID="LabelName" runat="server" Text='<%#Eval("activity_name")%>'></asp:Label>
                                <br />
                                <asp:Label ID="LabelDesc" runat="server" Text='<%#Eval("activity_description")%>'></asp:Label>
                                <br />
                                <asp:Label ID="LabelTotalVote" runat="server" Text='<%#Eval("vote")%>'></asp:Label>
                                <br />
                                <asp:Label ID="LabelTotalApp" runat="server" Text='<%#Eval("total_approval")%>'></asp:Label>
                                <br />
                                <asp:Label ID="LabelTotalDiss" runat="server" Text='<%#Eval("total_disapproval")%>'></asp:Label>
                                <br /><br />
                                <asp:Label ID="Label1" runat="server" Text="Select your vote for this proposal:" Font-Bold="True"></asp:Label>
                                ...
                                <br />
                                <asp:Label ID="Label2" runat="server" Text="Approval OR Disapproval:" Font-Bold="True"></asp:Label>
                                <asp:CheckBoxList ID="CheckBoxListApp" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Text="Approval" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Disapproval" Value="0"></asp:ListItem>
                                </asp:CheckBoxList>
                                <br />
                                <asp:Label ID="LabelComment" runat="server" Text="You can add your commands."></asp:Label>
                                <br />
                                <asp:TextBox ID="TextBox1" TextMode="MultiLine" runat="server"></asp:TextBox>
                                <br />
                                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Save" />
                                <br />
                                <asp:Label ID="LabelErrorVote" runat="server" Text="Voted before." Visible="false"></asp:Label><br /><asp:Label ID="LabelAppDisC" runat="server" Visible="false" Text="Select only one."></asp:Label>
                                <br />
                                <asp:Label ID="LabelAppdisSelect" runat="server" Text="Selected before." Visible="false"></asp:Label>
